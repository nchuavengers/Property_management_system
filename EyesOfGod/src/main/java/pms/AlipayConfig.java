...
public class AlipayConfig {
	...
	//public static String notify_url = "http://59.52.52.57/index";
	 ...
	 // 服务器异步通知页面路径  需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
    public static String notify_url = "http://kwver7.natappfree.cc/testalipay/aliPay/notify_url";

    // 页面跳转同步通知页面路径 需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
    public static String return_url = "http://kwver7.natappfree.cc/testalipay/aliPay/return_url";
	// 签名方式
